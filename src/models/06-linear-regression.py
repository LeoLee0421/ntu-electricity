...
results_df.to_csv(os.path.join(RESULT_FOLDER, "regression_results_summary.csv"), index=False)

print("\nProcess completed successfully.")
print("1. Statistical summary saved to regression_results_summary.csv")
